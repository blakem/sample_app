...
describe User do
  ...
  it "should accept valid email addresses" do
    addresses = %w[user@foo.com THE_USER@foo.bar.org first.last@foo.jp].each do |address|
  ...
  describe "passwords" do
    ...
    describe "password encryption" do
      ...
      describe "has_password? method" do
        ...
        it "should return false if the paswords do not match" do
      ...
      describe "authenticate method" do
        ...
        it "should return the user email/password mismatch" do
          User.authenticate(@attr[:email], @attr[:password]).should == @user
        end

        it "should return nil for email addres w/o user" do
  ...
  describe "micropost associations" do
    ...
    describe "status feed" do
      ...
      it "should include the mircoposts of the followed users" do
